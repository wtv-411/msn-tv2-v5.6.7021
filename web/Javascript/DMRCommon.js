...
var webPath					= ContentSync.WebPath;
var playlistFilename		= "playlist.asx";
var tempPlaylistUrl1		= "file://" + tempDir + "/1" + playlistFilename;
var tempPlaylistUrl2		= "file://" + tempDir + "/2" + playlistFilename;
var songDir 				= userDataVolumeName;
var songListUrl				= "file://" + songDir + "\\" + playlistFilename;
...
// DMRItem constructor
function DMRItem(name, href, contentType, checked, date, time, uid, thumbnailURL, printReadyURL, from, mailURL, subject )
{
