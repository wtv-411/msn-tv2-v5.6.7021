	...
	var xmlQSVersionStringDemo = "/msntvUpdate/String[@Id='L_DemoVersion_TEXT']";
	var xmlQSDescStringDemo = "/msntvUpdate/String[@Id='L_DemoDescription_TEXT']";
	var xmlQSAlreadyInstalledDemo = "/msntvUpdate/String[@Id='L_Demo_W_AlreadyInstalled_TEXT']";
	var xmlQSCopyErrorDemo = "/msntvUpdate/String[@Id='L_Demo_E_CopyError_TEXT']";
	var xmlQSSuccessDemo = "/msntvUpdate/String[@Id='L_DemoSuccess_TEXT']";
	var xmlQSNoRoomDemo = "/msntvUpdate/String[@Id='L_Demo_E_NoRoom_TEXT']";

	var xmlQSVersionString = "/msntvUpdate/String[@Id='L_Version_TEXT']";
	var xmlQSDescString = "/msntvUpdate/String[@Id='L_Description_TEXT']";
	var xmlQSAlreadyInstalled = "/msntvUpdate/String[@Id='L_W_AlreadyInstalled_TEXT']";
	var xmlQSCopyError = "/msntvUpdate/String[@Id='L_E_CopyError_TEXT']";
	var xmlQSSuccess = "/msntvUpdate/String[@Id='L_Success_TEXT']";
	var xmlQSNoRoom = "/msntvUpdate/String[@Id='L_E_NoRoom_TEXT']";
...
//	TVShell.Message("This is a patch");
	...
	if(!GetXMLText(xmlFileURL,xmlQSVersionStringDemo)) {
		TVShell.Message("This is a demo patch");
		xmlQSVersionString = xmlQSVersionStringDemo;
		xmlQSDescString = xmlQSDescStringDemo;
		xmlQSAlreadyInstalled = xmlQSAlreadyInstalledDemo;
		xmlQSCopyError = xmlQSCopyErrorDemo;
		xmlQSSuccess = xmlQSSuccessDemo;
		xmlQSNoRoom = xmlQSNoRoomDemo;
	} else {
		TVShell.Message("This is a general patch");
	}
