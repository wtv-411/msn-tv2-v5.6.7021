...
function IsTollFree(fieldValue)
{
	...
	var regExpArea855 = /^[(]855[)]\s{1}[0-9]{3}-[0-9]{4}$/;
	var regExpArea844 = /^[(]844[)]\s{1}[0-9]{3}-[0-9]{4}$/;
	var regExpArea833 = /^[(]833[)]\s{1}[0-9]{3}-[0-9]{4}$/;
	var regExpArea822 = /^[(]822[)]\s{1}[0-9]{3}-[0-9]{4}$/;
	...
	if (fieldValue.length == 14) {
		if( regExpArea800.test(fieldValue) )
			...
			result = true;
		else if( regExpArea855.test(fieldValue) )
			result = true;
		else if( regExpArea844.test(fieldValue) )
			result = true;
		else if( regExpArea833.test(fieldValue) )
			result = true;
		else if( regExpArea822.test(fieldValue) )
			result = true;
		else {
			result = false;
		}
